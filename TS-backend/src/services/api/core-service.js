...
export const findById = (model, id, filter = {}) => {
  return axiosRequest("GET", [model, ":id"].join("/"), filter, undefined, {
    id,
  })
}
...
export const findOne = (model, filter = {}) => {
  return axiosRequest("GET", [model, "findOne"].join("/"), filter)
}
export const updateAll = (model, filter = {}, data) => {
  //console.log(data)
  return axiosRequest("POST", [model, "update"].join("/"), filter, data)
}
export const deleteById = (model, id) => {
  return axiosRequest("DELETE", [model, id].join("/"), undefined, undefined, {
    id,
  })
}
...
export const updateAttributes = (model, id, data) => {
  return axiosRequest("PUT", [model, id].join("/"), undefined, data)
}

export const upsertPatch = (model, data = {}) => {
  return axiosRequest("PATCH", model, undefined, data)
}
