        ...
        <Table {...getTableProps()} className={tableClass}>
          ...
          <tfoot>
            <tr>
              ...
              <td className="text-center align-middle">{totalOpenIntCE}</td>
              <td className="text-center align-middle">{totalOpenInterestChangeCE}</td>
              <td className="text-center align-middle">{totalQtyTradedCE}</td>
              <td className="text-center align-middle">{/* Add other total sums here */}</td>
              <td className="text-center align-middle">{/* Add other total sums here */}</td>
              <td className="text-center align-middle "><h6>Total</h6></td>
              <td className="text-center align-middle">{/* Add other total sums here */}</td>
              <td className="text-center align-middle">{/* Add other total sums here */}</td>
              <td className="text-center align-middle">{totalQtyTradedPE}</td>
              <td className="text-center align-middle">{totalOpenInterestChangePE}</td>
              <td className="text-center align-middle">{totalOpenIntPE}</td>
            </tr>
          </tfoot>
        </Table>
      </div>
