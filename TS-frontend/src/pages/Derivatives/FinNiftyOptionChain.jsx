...
const FinNiftyOptionChain = () => {

  //meta title
  document.title = "Derivatives | FinNifty Option Chain";

  return (
    <div className="page-content">
      <div className="container-fluid">
        <Breadcrumbs title="Derivatives" breadcrumbItem="FinNifty Option Chain" />
...
FinNiftyOptionChain.propTypes = {
  preGlobalFilteredRows: PropTypes.any, 

};


export default FinNiftyOptionChain